    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
            ...
            >
              {[
                ...
                <div key={stat.label} className="bg-heritage-dark p-4 sm:p-5 md:p-6 rounded-xl border border-heritage-gold/10 text-center">
                  <stat.icon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-heritage-gold mx-auto mb-2 md:mb-3" />
                  <p className="text-2xl sm:text-2xl md:text-3xl font-serif font-bold text-heritage-cream">{stat.value}</p>
                  <p className="text-heritage-gray-light text-xs sm:text-sm">{stat.label}</p>
                </div>
              ))}
            </motion.div>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mt-10 md:mt-16">
            {values.map((value, index) => (
              ...
              >
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-heritage-gold/20 to-heritage-gold/5 flex items-center justify-center mx-auto mb-4 md:mb-6">
                  <value.icon size={32} className="md:w-10 md:h-10 text-heritage-gold" />
                </div>
      ...
      <section className="section-padding bg-heritage-charcoal">
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto mt-10 md:mt-16 px-4 sm:px-0">
            {milestones.map((milestone, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
                className="flex items-center gap-4 sm:gap-6 md:gap-8 mb-6 md:mb-8 last:mb-0"
              >
                <div className="w-16 sm:w-20 md:w-24 flex-shrink-0">
                  <span className="text-lg sm:text-xl md:text-2xl font-serif font-bold text-heritage-gold">
                    {milestone.year}
                  </span>
                </div>
                <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-heritage-gold flex-shrink-0" />
                <div className="flex-1 bg-heritage-dark p-4 sm:p-5 md:p-6 rounded-xl border border-heritage-gold/10">
                  <p className="text-heritage-cream text-sm sm:text-base">{milestone.event}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="section-padding bg-heritage-black relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-heritage-gray-light text-base md:text-lg leading-relaxed mb-6 md:mb-8 px-4 sm:px-0">
