      ...
      <section className="relative h-[50vh] flex items-center">
        ...
        <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-heritage-gray-light max-w-2xl mx-auto">
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-heritage-gold/10 flex items-center justify-center mb-4">
                  <info.icon size={24} className="text-heritage-gold" />
                </div>
                <h3 className="text-lg font-serif font-semibold text-heritage-cream mb-3">
                  {info.title}
                </h3>
                {info.details.map((detail) => (
                  <p key={detail} className="text-heritage-gray-light text-sm">
                    {detail}
                  </p>
                ))}
              </motion.div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            {submitted ? (
              ...
              >
                <CheckCircle size={64} className="text-heritage-gold mx-auto mb-6" />
                <h3 className="text-2xl font-serif font-semibold text-heritage-cream mb-4">
                  Thank You
                </h3>
                <p className="text-heritage-gray-light">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-heritage-dark border border-heritage-gold/20 rounded-xl px-4 py-3 text-heritage-cream placeholder-heritage-gray-light focus:outline-none focus:border-heritage-gold transition-colors"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-heritage-dark border border-heritage-gold/20 rounded-xl px-4 py-3 text-heritage-cream focus:outline-none focus:border-heritage-gold transition-colors"
                    >
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="mt-12 rounded-2xl overflow-hidden border border-heritage-gold/20"
            >
              <iframe
